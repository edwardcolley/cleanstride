...
--
-- Host: localhost:3306
-- Generation Time: Oct 22, 2019 at 11:54 PM
...
(249, 'FRIDAY', 'NEWPORT BEACH', '6:30 AM', '(O)', 'CHICKEN COOP ROUND TABLE', '414 Old Newport Blvd @ Hospital Rd (Chicken Coop)', 92663, 'AA'),
(250, 'FRIDAY', 'NEWPORT BEACH', '6:30 AM', '(O)', 'JUMPSTART DISCUSSION', '414 E. 32nd St.', 92663, 'AA'),
(251, 'FRIDAY', 'NEWPORT BEACH', '6:30 AM', '(O)', 'ROUND TABLE TOPIC DISCUSSION', '414 E. 32nd St', 92663, 'AA'),
(252, 'FRIDAY', 'NEWPORT BEACH', '6:45 AM', '(O)', '6:45 AM DAILY ATTITUDE ADJUSTMENT', '1099 Bayside Dr @ Jamboree (Newport Beach Yacht Club)', 92660, 'AA'),
(253, 'FRIDAY', 'NEWPORT BEACH', '8:00 AM', '(O)', 'TWO OR MORE- LIVING SOBER', '414 E. 32nd St.', 92663, 'AA'),
(254, 'FRIDAY', 'NEWPORT BEACH', '12:15 PM', '(C,M)', 'FRIDAY MEN\'S CLOSED GROUP DISCUSSION', '414 E. 32nd St.', 92663, 'AA'),
(255, 'FRIDAY', 'NEWPORT BEACH', '12:15 PM', '(O)', 'SHARK AT THE AQUATIC CENTER', '1 Whitecliffs Dr. (Newport Aquatic Center)	', 92660, 'AA'),
(256, 'FRIDAY', 'NEWPORT BEACH', '2:00 PM ', '(O)', 'NEWPORT NOMADS', '414 Old Newport Blvd @ Hospital Rd (Chicken Coop, downstairs)', 92663, 'AA'),
(257, 'FRIDAY', 'NEWPORT BEACH', '3:30 PM', '(O)', 'HAPPYHOUR AND A HALF', '414 E. 32nd St.', 92663, 'AA'),
(258, 'FRIDAY', 'NEWPORT BEACH', '5:30 PM', '(C)', 'FISH OUT\'A WATER', '414 E. 32nd St.', 92663, 'AA'),
(259, 'FRIDAY', 'NEWPORT BEACH', '6:45 PM', '(O)', 'FRIDAY NIGHT LIGHT BIG BOOK STUDY', '301 Newport Blvd. @ PCH (Hoag Chemical Dependency Unit)', 92663, 'AA'),
(260, 'FRIDAY', 'NEWPORT BEACH', '7:00 PM ', '(O)', 'SPIRIT OF RECOVERY', '414 E. 32nd St. (Upstairs)', 92663, 'AA'),
(261, 'FRIDAY', 'NEWPORT BEACH', '7:30 PM', '(O)', 'MISFITS', '414 E. 32nd St. (Downstairs)', 92663, 'AA'),
(262, 'FRIDAY', 'NEWPORT BEACH', '8:15 PM', '(O,GA)', 'PRIDE N\' PROGRAM - LGBTQ', '414 E. 32nd St. (Upstairs)', 92663, 'AA'),
(263, 'SATURDAY', 'NEWPORT BEACH', '7:00 AM', '(O)', 'ROUND TABLE TOPIC DISCUSSION', '414 E. 32nd St.', 92663, 'AA'),
(264, 'SATURDAY', 'NEWPORT BEACH', '7:00 AM', '(O)', 'JUMPSTART DISCUSSION', '414 E. 32nd St.', 92663, 'AA'),
(265, 'SATURDAY', 'NEWPORT BEACH', '8:00 AM', '(C,M)', 'MEN\'S CASTAWAYS', '798 Dover Dr @ 16th Street (Newport Harbor Lutheran Church, downstairs)', 92663, 'AA');
...
INSERT INTO `Calendar` (`id`, `program_id`, `sessionID`) VALUES
(1, 4, 2);
...
INSERT INTO `Favorites` (`id`, `program_id`, `sessionID`) VALUES
(2, 3, 2),
(3, 4, 2),
(4, 5, 2),
(5, 1, 5),
